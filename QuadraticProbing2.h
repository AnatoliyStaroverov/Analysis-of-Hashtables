#ifndef QUADRATIC_PROBING2_H
#define QUADRATIC_PROBING2_H
...
{
  public:
    explicit HashTable_5( int size = 101 ) : array( nextPrime1( size ) )
      { makeEmpty( ); }
  ...
  private:
    ...
    size_t PreHash( const HashedObj & x) const 
    {
